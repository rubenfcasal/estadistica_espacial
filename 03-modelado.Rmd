...
```{r vario-rvario-cloud, fig.cap="Nubes de semivarianzas clásicas (izquierda) y robustas (derecha) del conjunto de datos simulado.", fig.dim = c(12, 6), out.width = "90%"}
...
```{r vario-rvario, fig.cap="Estimaciones clásicas y robustas del semivariograma (datos simulados)."}
