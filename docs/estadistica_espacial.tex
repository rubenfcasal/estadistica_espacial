...
Entre ellos destacan el paquete \href{https://CRAN.R-project.org/package=sp}{\texttt{sp}} Bivand et~al. (\protect\hyperlink{ref-Bivand2013}{2013}) y el paquete \href{https://r-spatial.github.io/sf}{\texttt{sf}} E. Pebesma y Bivand (\protect\hyperlink{ref-Pebesma2021}{2021}).
...
Para detalles sobre la conversión entre datos ráster y datos vectoriales ver por ejemplo las secciones \href{https://keen-swartz-3146c4.netlify.app/sf.html\#raster-to-vector}{7.5} y \href{https://keen-swartz-3146c4.netlify.app/sf.html\#warp}{7.7} de E. Pebesma y Bivand (\protect\hyperlink{ref-Pebesma2021}{2021}).
...
\protect\hypertarget{exr:descriptiva}{}\label{exr:descriptiva}Realizar un análisis exploratorio del conjunto de datos \texttt{s100} del paquete \texttt{geoR}
...
\protect\hypertarget{exr:descriptiva2}{}\label{exr:descriptiva2}Realizar un análisis exploratorio del conjunto de datos \texttt{meuse\_sf} (almacenado en
...
El paquete \href{https://CRAN.R-project.org/package=sp}{\texttt{sp}} {[}Classes and methods for spatial data; E. J. Pebesma y Bivand (\protect\hyperlink{ref-Pebesma2005}{2005}){]} implementa objetos y métodos para datos espaciales.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.1325}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.8675}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Método
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
En el modelo anterior, en lugar de errores incorrelados, si suponemos que:
\[Var\left( \boldsymbol{\varepsilon} \right) =\boldsymbol{\Sigma},\]
obtenemos el modelo lineal de regresión generalizado y en este caso el estimador lineal óptimo de \(\boldsymbol{\beta}\) es el estimador de mínimos cuadrados generalizados (GLS, \emph{generalized least squares}; WLS, \emph{weighted least squares}, como caso particular si es diagonal):
\begin{equation} 
...
\leavevmode\vadjust pre{\hypertarget{ref-Pebesma2021}{}}%
