...
Como aparece en la ayuda de esta función, es preferible usar el paquete \texttt{geoR} (ver Sección \ref{ajuste-de-un-modelo-de-variograma} del apéndice) y también se podría emplear el paquete \texttt{nlme}.
