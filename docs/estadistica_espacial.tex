...
\subsection{\texorpdfstring{El paquete \textbf{gstat}}{El paquete gstat}}\label{el-paquete-gstat}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{with}\NormalTok{(vario, }\FunctionTok{plot}\NormalTok{(dist, gamma, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{, }
