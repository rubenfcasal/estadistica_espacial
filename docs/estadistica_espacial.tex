...
\tightlist
\item
  \texttt{nsim}: número de generaciones. Si se establece un valor distinto de cero, se emplea simulación condicional en lugar de predicción kriging (ver Fernández-Casal y Cao, 2020, \href{https://rubenfcasal.github.io/simbook/simulaci\%C3\%B3n-condicional-e-incondicional.html}{Sección 7.5}).
\item
...
Ejemplos: \href{s100.html}{s100} (KO) y \href{aquifer.html}{aquifer} (KU).
...
(BLUP, \emph{best linear unbiased predictor}). Si el proceso es gaussiano, este predictor resulta ser el predictor más eficiente.
