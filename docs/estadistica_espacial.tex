...
\protect\hypertarget{exr:aquifer2}{}{\label{exr:aquifer2} \iffalse (Creación de una rejilla de predicción) \fi{} }
...
\NormalTok{fit.cressie }\OtherTok{\textless{}{-}} \FunctionTok{fit.variogram}\NormalTok{(vario, }\AttributeTok{model =}\NormalTok{ fit.lin, }\AttributeTok{fit.method =} \DecValTok{2}\NormalTok{) }
\CommentTok{\# Representar:}
\CommentTok{\# Cuidado con plot.variogramModel() si se pretende añadir elementos}
...
\FunctionTok{lines}\NormalTok{(}\FunctionTok{variogramLine}\NormalTok{(fit.cressie, }\AttributeTok{maxdist =} \FloatTok{0.6}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Parámetros estimados:}
\NormalTok{fit.cressie}
\end{Highlighting}
\end{Shaded}
...
Por ejemplo, considerando el modelo lineal de la Sección \ref{modelos-clasicos-espaciales} (el modelo del \emph{kriging universal}, Sección 4.X), tendríamos que:
...
\NormalTok{vario.trend }\OtherTok{\textless{}{-}} \FunctionTok{variogram}\NormalTok{(head }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lon }\SpecialCharTok{+}\NormalTok{ lat, aquifer\_sf, }\AttributeTok{cutoff =} \DecValTok{150}\NormalTok{)    }
\NormalTok{oldpar }\OtherTok{\textless{}{-}} \FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
...
\CommentTok{\# plot(vario.trend)}
\FunctionTok{with}\NormalTok{(vario.trend,  }\FunctionTok{plot}\NormalTok{(dist, gamma, }\AttributeTok{xlab =} \StringTok{"distance"}\NormalTok{, }\AttributeTok{ylab =}  \StringTok{"semivariance"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
