...
\begin{exercise}[Creación de rejilla de predicción]
\protect\hypertarget{exr:aquifer2}{}{\label{exr:aquifer2} \iffalse (Creación de rejilla de predicción) \fi{} }
...
\begin{exercise}[Creación de rejilla de predicción]
\protect\hypertarget{exr:descriptiva}{}{\label{exr:descriptiva} \iffalse (Creación de rejilla de predicción) \fi{} }
Realizar un análisis descriptivo del conjunto de datos \texttt{s100} del paquete \texttt{geoR}
(que contiene una simulación de un proceso espacial estacionario, sin tendencia;
ver Sección \ref{vario-muestrales}).

Realizar un análisis descriptivo del conjunto de datos \texttt{meuse\_sf} (almacenado en
el archivo \emph{st\_meuse.RData}) considerando únicamente las variables que comparte
con la rejilla \texttt{meuse\_grid}.
\end{exercise}
