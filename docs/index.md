...
La versión actual del libro ***se está desarrollando*** principalmente como apoyo la docencia de la segunda parte de la signatura de [Análisis estadístico de datos con dependencia](https://guiadocente.udc.es/guia_docent/index.php?centre=614&ensenyament=614G02&assignatura=614G02022&idioma=cast) del [Grado en Ciencia e Ingeniería de Datos](https://estudos.udc.es/es/study/start/614G02V01) de la [UDC](https://www.udc.es). 
...
pkgs <- c("sf", "sp", "starts", "gstat", "geoR", "spacetime", "sm", "fields", 
          ...
          "classInt", "viridis", "dplyr", "mapSpain", "mapview", "tmap", "mapview", 
...
```
Aunque al necesitar compilación los usuarios de Windows necesitan tener instalado previamente la versión adecuada de [Rtools](https://cran.r-project.org/bin/windows/Rtools/), y los usuarios de OS X [Xcode](https://apps.apple.com/us/app/xcode/id497799835)
